...
export default {
    ...
    state: {
        ...
        taxes_and_charges: [
          {value: 0.50, name:"pis_pasep", text:"PIS/PASEP", prefix:"", suffix:"%", type:"number"},
          {value: 2.31, name:"cofins", text:"COFINS", prefix:"", suffix:"%", type:"number"},
          {value: 25, name:"icms", text:"ICMS", prefix:"", suffix:"%", type:"number"},
          {value: 18.40, name:"cip_cosip", text:"CIP ou COSIP", prefix:"R$", suffix:"", type:"number"},
          {value: 0, name:"others", text:"Outros", prefix:"R$", suffix:"", type:"number"},
        ],
